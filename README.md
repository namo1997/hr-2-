...
- ✅ **กฎ OT ใหม่:** แสดงผลเมื่อทำงานเกิน 30 นาทีหลังเลิกกะ หรือพักไม่ครบ 30 นาที
- ✅ **คำนวณสายแยก:** แยก “มาสายจากเข้า” vs “มาสายจากพัก” และรวมยอดรวม
- ✅ **Work Calculation ต้องเลือกสาขา/แผนก:** ก่อนคำนวณต้องเลือก Branch + Department พร้อมป้ายเตือนและตัวชี้ “รอตรวจสอบ” สำหรับบันทึกที่สแกนไม่ครบ
- ✅ **Period กะทำงาน:** Shift รองรับ `cycleStartDay`/`cycleEndDay` เพื่อกำหนดรอบคำนวณเงินเดือน (ปกติ 26-25)
...
### 0. ยื่นคำขอลา (Self-Service Leave)
- ไปที่ **การขอลา** จากหน้าแรก (หรือเปิด `/leave`)
  - เลือกโซน → สาขา → แผนก → พนักงาน เพื่อให้ระบบดึงสายบังคับบัญชาที่ถูกต้อง
  - เลือกรูปแบบการลา:
    - **ลาเต็มวัน**: ระบุช่วงวันเริ่ม-สิ้นสุด ระบบคำนวณจำนวนวันให้
    - **ลารายชั่วโมง**: เลือกวันเดียวพร้อมกำหนดเวลาเริ่ม/สิ้นสุด ขั้นต่ำ 30 นาที
    - **ลาแบบผสม**: ผสมวันเต็มและช่วงเวลาชั่วโมงได้หลายรายการ (ต้องเป็นทวีคูณ 30 นาที)
  - เปิดตัวเลือก “ขอย้อนหลัง” หากต้องการเลือกวันที่ผ่านมาแล้ว ระบบจะตรวจว่ามีการลงเวลาทำงานจริงหรือไม่ לפניอนุมัติ
